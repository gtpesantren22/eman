...
if ($level == 'admin') {
    $santri =  query("SELECT a.id, a.nis, a.kasus, a.tanggal, a.stts, a.sanksi, a.pj, b.nama, b.k_formal, b.t_formal, b.k_madin, b.r_madin, b.kamar, b.komplek FROM pelanggaran AS a INNER JOIN tb_santri AS b ON a.nis=b.nis WHERE a.sanksi = '-' AND a.pj = '-' AND kasus != 'Telat Kembali' ");
} elseif ($level == 'putra') {
    $santri =  query("SELECT a.id, a.nis, a.kasus, a.tanggal, a.stts, a.sanksi, a.pj, b.nama, b.k_formal, b.t_formal, b.k_madin, b.r_madin, b.kamar, b.komplek FROM pelanggaran AS a INNER JOIN tb_santri AS b ON a.nis=b.nis WHERE jkl = 'Laki-laki' AND a.sanksi = '-' AND a.pj = '-' AND kasus != 'Telat Kembali' ");
} else {
    $santri =  query("SELECT a.id, a.nis, a.kasus, a.tanggal, a.stts, a.sanksi, a.pj, b.nama, b.k_formal, b.t_formal, b.k_madin, b.r_madin, b.kamar, b.komplek FROM pelanggaran AS a INNER JOIN tb_santri AS b ON a.nis=b.nis WHERE jkl = 'Perempuan' AND a.sanksi = '-' AND a.pj = '-' AND kasus != 'Telat Kembali' ");
}
?>
