            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <?php if ($ket == 1) {
                        ...
                        $beda = $diff->format('%a');
                    ?>
                    <label class="label label-primary float-right" style="font-size: 15px;">Estimasi
                        keterlambatan :
                        <?= $beda ?>
                        hari</label>
                    <?php } ?>
                    ...
                    <form action="" method="post">
                        ...
                        <input type="hidden" name="nis" value="<?= $r2['nis'] ?>">
                        <input type="hidden" name="wajib_kembali" value="<?= $r2['wajib_kembali'] ?>">
                        <ul class="chat-list">
                            <!--chat Row -->
                            <li class="chat-item">
                                ...
                                <div class="chat-content">
                                    ...
                                    <input type="text" name="tgl_kembali" class="form-control is-valid"
                                        id="datepicker-autoclose" autocomplete="off" required
                                        value="<?= $r2['tgl_kembali'] ?>">
                                </div>
                                <div class="chat-content">
                                    <h6 class="font-medium">Persyaratan</h6>
                                    <input type="text" name="syarat" class="form-control is-valid" autocomplete="off"
                                        required value="<?= $r2['syarat'] ?>">
                                </div>
                                <hr>
                                <div class=" chat-content">
                                    <button class="btn btn-primary" name="ok" type="submit"><span
